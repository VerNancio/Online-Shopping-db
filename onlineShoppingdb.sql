...
CREATE TABLE IF NOT EXISTS `address` (
	addrid SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
    userid INT UNSIGNED NOT NULL,
    ...
    CONSTRAINT fk_address_user FOREIGN KEY (userid) REFERENCES `User` (userid) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `CreditCard` (
    ...
    CONSTRAINT fk_creditcard_bankcard FOREIGN KEY (cardNumber) REFERENCES `BankCard` (cardNumber) ON DELETE RESTRICT ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS `DebitCard` (
	cardNumber CHAR(19) NOT NULL,
    
    CONSTRAINT fk_debitcard_bankcard FOREIGN KEY (cardNumber) REFERENCES `BankCard` (cardNumber) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `Store` (
    ...
    customerGrade INT UNSIGNED NOT NULL, -- REVER
...
CREATE TABLE IF NOT EXISTS `ServicePoint` (
	addrid SMALLINT UNSIGNED NOT NULL,
    ...
    CONSTRAINT fk_servicepoint_address FOREIGN KEY (addrid) REFERENCES `address` (addrid) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
ALTER TABLE Store ADD FOREIGN KEY (customerGrade) REFERENCES Product (pid) ON DELETE RESTRICT ON UPDATE CASCADE;
...
CREATE TABLE IF NOT EXISTS `Comments` (
    ...
    CONSTRAINT fk_comments_user FOREIGN KEY (userId) REFERENCES `User` (userId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_comments_product FOREIGN KEY (pid) REFERENCES `Product` (pid) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `Save_to_Shopping_Cart` (
    ...
    CONSTRAINT fk_savetoshoppingcat_user FOREIGN KEY (userId) REFERENCES `User` (userId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_savetoshoppingcat_product FOREIGN KEY (pid) REFERENCES `Product` (pid) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `Manage` (
    ...
    CONSTRAINT fk_manage_user FOREIGN KEY (userId) REFERENCES `User` (userId) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_manage_store FOREIGN KEY (sid) REFERENCES `Store` (sid) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `After_Sales_Service_At` (
    ...
    CONSTRAINT fk_afterSalesServiceAt_address FOREIGN KEY (addrid) REFERENCES `Address` (addrid) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `Contain` (
    ...
    CONSTRAINT fk_contain_order FOREIGN KEY (orderNumber) REFERENCES `Orders` (orderNumber) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_orderitem_order FOREIGN KEY (itemId) REFERENCES `OrderItem` (itemId) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `deliver_to` (
    ...
    CONSTRAINT fk_deliver_address FOREIGN KEY (addrid) REFERENCES `Address` (addrid) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_deliver_orders FOREIGN KEY (orderNumber) REFERENCES `Orders` (orderNumber) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS `Payment` (
    ...
    CONSTRAINT fk_payment_orders FOREIGN KEY (orderNumber) REFERENCES `Orders` (orderNumber) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_payment_bankcard FOREIGN KEY (cardNumber) REFERENCES `BankCard` (cardNumber) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO bankcard VALUES('4023 1231 3431 8623', 18, '2039-9-10','CIBC');
INSERT INTO bankcard VALUES('5872 8293 3321 0123', 15, '2020-5-14','BMO');
INSERT INTO bankcard VALUES('4902 9212 3402 8831', 5, '2027-7-01','CIBC');
INSERT INTO bankcard VALUES('5782 7293 8472 0318', 1, '2028-8-15','CIBC');
INSERT INTO bankcard VALUES('4509 4462 9302 0716', 3, '2030-1-30','CIBC');
INSERT INTO bankcard VALUES('8473 9299 8492 7361', 41, '2024-6-20','BMO');
INSERT INTO bankcard VALUES('4457 4992 7391 0219', 32, '2025-8-30','BMO');
INSERT INTO bankcard VALUES('5728 8391 7362 5381', 30, '2035-5-20','CIBC');
INSERT INTO bankcard VALUES('7283 8982 8361 5593', 24, '2029-4-14','BMO');
INSERT INTO bankcard VALUES('9238 2749 5738 5921', 12, '2027-8-01','CIBC');
INSERT INTO bankcard VALUES('2839 8219 3728 2933', 9, '2031-5-20','CIBC');


INSERT INTO creditcard VALUES('4902 9212 3402 8831','VISA');
INSERT INTO creditcard VALUES('4023 1231 3431 8623','MASTER');
INSERT INTO creditcard VALUES('8473 9299 8492 7361','VISA');
INSERT INTO creditcard VALUES('7283 8982 8361 5593','VISA');
INSERT INTO creditcard VALUES('9238 2749 5738 5921','MASTER');
INSERT INTO creditcard VALUES('2839 8219 3728 2933','VISA');


INSERT INTO debitcard VALUES('5872 8293 3321 0123');
INSERT INTO debitcard VALUES('5728 8391 7362 5381');
INSERT INTO debitcard VALUES('4457 4992 7391 0219');
INSERT INTO debitcard VALUES('5782 7293 8472 0318');
INSERT INTO debitcard VALUES('4509 4462 9302 0716');
